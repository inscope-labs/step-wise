...
- Pending for 1.6.0: running the acceptance scenarios against one or more real models and acting on what they show; the token-accurate size measurement with the real tokenizer; the example transcript; removing the `-dev` suffix and dating the release.
